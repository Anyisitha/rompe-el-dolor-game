window.onload = function () {
    ...
    // * TRANSICIONES
    const counterWrapper = $('#level-2 .counter-wrapper');
    const gameWrapper = $('#level-2 .game-wrapper');
    const resultsScreen = $('#level-2 .result-wrapper');
    const losePop = $('#level-2 .result-wrapper .lose-pop');
    const winPop = $('#level-2 .result-wrapper .win-pop-2');

    startCounter();

    function startCounter() {
        setTimeout(() => {
            $('.portada-level-2').fadeOut('fast');
            $('#counter-level-2').fadeIn('fast');
            let audiocard2 = document.getElementById('audiocard2')
            audiocard2.play();
        }, 1500);

        setTimeout(() => {
            $('#counter-level-2').fadeOut('fast');
            $('.go-text').fadeIn('fast');
        }, 4000);
    ...
    function init() {
        ...
        images = loadImages(["../../assets/images/square-sprite.png"]);
    ...
    infoPopImages.redImages[0].src = '../../assets/images/info-pink-1-level-2.png';
    infoPopImages.redImages[1].src = '../../assets/images/info-pink-2-level-2.png';
    infoPopImages.blueImages[0].src = '../../assets/images/info-blue-1-level-2.png';
    infoPopImages.blueImages[1].src = '../../assets/images/info-blue-2-level-2.png';
    infoPopImages.yellowImages[0].src = '../../assets/images/info-orange-1-level-2.png';
    infoPopImages.yellowImages[1].src = '../../assets/images/info-orange-2-level-2.png';
    infoPopImages.purpleImages[0].src = '../../assets/images/info-black-1-level-2.png';
    infoPopImages.purpleImages[1].src = '../../assets/images/info-black-2-level-2.png';
    ...
    const painImage = $('.pain-image-level-2');
    ...
    painImages.redImage.src = '../../assets/images/pink-pain-level-2.png';
    painImages.blueImage.src = '../../assets/images/blue-pain-level-2.png';
    painImages.yellowImage.src = '../../assets/images/orange-pain-level-2.png';
    painImages.purpleImage.src = '../../assets/images/black-pain-level-2.png';
    ...
    // * RESTART GAME
    $(document).on('click', '#level-2 .result-wrapper .retry', () => {
        newGame();
        shootsCounter = 35;
        shootsText.text(shootsCounter);
    ...
    // * PASAR A REFERENCIAS
    const referencesPop = $('#level-2 .result-wrapper .references');

    $('#level-2 .result-wrapper .continue').click(() => {
        newGame();
