window.onload = function () {
    ...
    // * TRANSICIONES
    const counterWrapper = $('#level-3 .counter-wrapper');
    const gameWrapper = $('#level-3 .game-wrapper');
    const resultsScreen = $('#level-3 .result-wrapper');
    const losePop = $('#level-3 .result-wrapper .lose-pop');
    const winPop = $('#level-3 .result-wrapper .win-pop-3');

    startCounter();

    function startCounter() {
        setTimeout(() => {
            $('.portada-level-3').fadeOut('fast');
            $('#counter-level-3').fadeIn('fast');
            let audiocard2 = document.getElementById('audiocard2')
            audiocard2.play();
        }, 1500);

        setTimeout(() => {
            $('#counter-level-3').fadeOut('fast');
            $('.go-text').fadeIn('fast');
        }, 4000);
    ...
    function init() {
        ...
        images = loadImages(["../../assets/images/bubble-sprite.png"]);
    ...
    infoPopImages.redImages[0].src = '../../assets/images/info-pink-1-level-3.png';
    infoPopImages.redImages[1].src = '../../assets/images/info-pink-2-level-3.png';
    infoPopImages.blueImages[0].src = '../../assets/images/info-green-1-level-3.png';
    infoPopImages.blueImages[1].src = '../../assets/images/info-green-2-level-3.png';
    infoPopImages.yellowImages[0].src = '../../assets/images/info-orange-1-level-3.png';
    infoPopImages.yellowImages[1].src = '../../assets/images/info-orange-2-level-3.png';
    infoPopImages.purpleImages[0].src = '../../assets/images/info-brown-1-level-3.png';
    infoPopImages.purpleImages[1].src = '../../assets/images/info-brown-2-level-3.png';
    ...
    const painImage = $('.pain-image-level-3');
    ...
    painImages.redImage.src = '../../assets/images/pink-pain-level-3.png';
    painImages.blueImage.src = '../../assets/images/green-pain-level-3.png';
    painImages.yellowImage.src = '../../assets/images/orange-pain-level-3.png';
    painImages.purpleImage.src = '../../assets/images/brown-pain-level-3.png';
    ...
    // * RESTART GAME
    $(document).on('click', '#level-3 .result-wrapper .retry', () => {
        newGame();
        shootsCounter = 35;
        shootsText.text(shootsCounter);
    ...
    // * PASAR A REFERENCIAS
    const referencesPop = $('#level-3 .result-wrapper .references');

    $('#level-3 .result-wrapper .continue').click(() => {
        newGame();
